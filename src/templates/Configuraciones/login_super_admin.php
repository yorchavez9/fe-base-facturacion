                    ...
                    <div class="card-body" >
                        ...
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="Usuario / Correo" name="user" id="usuarioLogin" type="text" autofocus autocomplete="off" value="<?= $usuario?>">
                            </div>
                            <div class="form-group ">
                                <div class="d-flex align-items-center div-pwd-input">
                                    <input class="col pwd-input" placeholder="Clave" name="pwd" id="claveLogin" type="password">

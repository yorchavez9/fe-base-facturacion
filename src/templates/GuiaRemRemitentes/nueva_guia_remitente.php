        ...
        <div class="input-group input-group-sm">
            ...
            <?=
                $this->Form->control('anular_guia_codigo', [
                    ...
                    'placeholder'   =>  'Ejem. T003-00000001',
                    'readonly'      =>  true
                ])
            ?>
...
<div class="row">
    ...
    <div class="col-sm-12 col-md-6 col-lg-8 mb-2">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <i class="fas fa-exchange-alt fa-fw"></i> &nbsp; Motivo de Traslado
                </span>
            </div>
            <select name="motivo_traslado" class="form-control" id="motivo_traslado" onchange="GuiaremRemitenteAdd.cambioMotivoTraslado()">
                <?php foreach ($motivo_traslado as $k => $motivo) : ?>
                    <option value="<?= $k ?>"><?= $motivo ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
...
<div class="row my-3" id="div_doc_add" style="display:none">
    ...
    <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
        <div class="input-group input-group-sm">
            ...
            <select name="doc_adicional_tipo" class="form-control" >
    ...
    <div class="col-sm-12 col-md-6 col-lg-2 mb-2">
        <div class="input-group input-group-sm">
            ...
            <input type="text" name="doc_adicional_serie" class="form-control" placeholder="Serie" autocomplete="off" >
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
        <div class="input-group input-group-sm">
            ...
            <input type="text" name="doc_adicional_correlativo" class="form-control" placeholder="Correlativo" autocomplete="off" >
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-4 mb-2">
        <div class="input-group input-group-sm">
            ...
            <input type="text" name="doc_adicional_emisor" class="form-control" placeholder="RUC Remitente" autocomplete="off" >
        </div>
    </div>
</div>
<div class="row">
    ...
    <!-- solo para importacion, falta implementar
    <div class="col-md-2">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text">
            ...
            <input class="form-control" type="number" name="nro_paquetes" step="any" min="1" value="1" required>
        </div>
    </div>
    -->
...
<div class="row mb-3" id="establecimientosLocales" hidden>
    <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <i class="fas fa-truck-moving fa-fw"></i> Establecimiento de Origen
                </span>
            </div>
            <select name="codigo_establecimiento_origen" id="codigo_establecimiento_origen" class="form-control form-control-sm">
                <option value="">-Seleccione-</option>
            </select>
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text">
                    <i class="fas fa-truck-moving fa-fw"></i> Establecimiento de Destino
                </span>
            </div>
            <select name="codigo_establecimiento_destino" id="codigo_establecimiento_destino" class="form-control form-control-sm">
                <option value="">-Seleccione-</option>
            </select>
        </div>
    </div>

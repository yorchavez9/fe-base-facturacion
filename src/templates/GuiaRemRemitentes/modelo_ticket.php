...
<header>
    ...
    <h5>
        <?php
        $tipodocumento = "Nota de Venta <br/> (sin validez fiscal)";
        switch($venta->documento_tipo){
            case 'FACTURA': $tipodocumento = "Factura Electrónica"; break;
            case 'BOLETA': $tipodocumento = "Boleta de Venta Electrónica"; break;
        }
        echo $tipodocumento;
        echo "<br/>";
        echo $venta->documento_serie . "-" . $venta->documento_correlativo;
        ?>
    </h5>
</header>
...
<br/>
<p class="info_pie">
    Representación Impresa del Comprobante Electrónico autorizado según Sunat. Consulte su validez visitando nuestro sitio web.
</p>
<br/>
<br/>
<br/>

<?php
echo $this->Form->create(null, ['id' => 'formNuevoParteEntrada']);
...
<div class="row">
    ...
    <div class="col-12 col-sm-<?= !$flag_ps ? '2' : '4'?>">
        <div class="form-group">
            <label for="">Fecha</label>
            <input type="text" name="fecha" class="form-control form-control-sm" placeholder="Fecha" autocomplete="off" value="<?= date('Y-m-d') ?>" readonly >
        </div>
    </div>
    ...
    <?php /* if(!$flag_ps): ?>
        <div class="col-12 col-sm-2">
            <br>
            <div class="form-group ">
                <button class="mt-2 btn btn-sm btn-info w-100" type="button"  data-toggle="modal" data-target="#modalCargarParteSalida" >Cargar</button>
            </div>
        </div>
    <?php endif; */ ?>
    <div class="col-12">
    ...
    <div class="col-12 col-sm-9">
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <button type="button" class="btn btn-sm btn-primary" id="basic-addon2" onclick="ParteEntrada.abrirBuscadorProductos()">
...
<div class="modal fade" id="modalCargarParteSalida" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modalCargarParteSalidaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <label>Cargar detalle desde Parte de Salida</label>
                <div class="row">
                    <div class="col-md-10">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" class="form-control" name="codigo_parte_salida" placeholder="Ejemplo: PS-00000001"  autocomplete="off" />
                            <div class="input-group-append">
                                <button type="button" onclick="ParteEntrada.buscarParteSalida()" class="btn btn-sm btn-outline-primary" id="load_ps"><i class="fas fa-check fa-fw"></i></button>
                            </div>
                            <div class="invalid-feedback">
                                Ingresar un codigo.
                            </div>
                            <div class="valid-feedback">
                                Espere mientras cargamos el documento...
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
...
if($flag_ps && $parte_salida){
    echo $this->Html->scriptBlock(" var parte_salida_enable = true");
    echo $this->Html->scriptBlock(" var parte_salida_registros = " . json_encode($parte_salida->parte_salida_registros));
}else{
    echo $this->Html->scriptBlock(" var parte_salida_enable = false");
}

...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
        ...
        <div class="input-group input-group-sm">
            ...
            <input type="hidden" name="establecimiento_id" value="">
            <input type="hidden" name="establecimiento_codigo" value="">
            <input type="hidden" name="establecimiento_ubigeo" value="">
            <input type="hidden" name="establecimiento_departamento" value="">
            <input type="hidden" name="establecimiento_provincia" value="">
            <input type="hidden" name="establecimiento_distrito" value="">
            <input type="hidden" name="establecimiento_urbanizacion" value="">
            <input type="hidden" name="establecimiento_direccion" value="">
            <input class="form-control" type="text" name="establecimiento" readonly value=">" />
        </div>
    </div>
...
<div class="row"  id="direccionPartida">
    <div class="col-sm-12 col-md-6 col-lg-5 mb-2">
        <div class="input-group input-group-sm">
            ...
            <input type="hidden" name="partida_ubigeo" class="class_partida" value="" />
            <input type="text" name="partida_ubigeo_full" class="form-control form-control-sm class_partida" placeholder="Distrito / Provincia / Región" value="" required />
        </div>
    </div>
    <div class="col-sm-12 col-md-6 col-lg-7 mb-2">
        <input type="text" name="partida_direccion" class="form-control form-control-sm class_partida" placeholder="Dirección de Partida" autocomplete="off" value="" required>
    </div>
</div>

var View = {
    ...
    generarXml  : function(id){
        ...
        if (r){
            $.ajax({
                url: `${base}sunat-fe-guiarem-transportistas/generar-xml/${id}`,
                data: '',
                type: 'POST',
                success: function (r) {
                    console.log(r);
    ...
    enviarSunat: function(id){
        ...
        $.ajax({
            url: `${base}sunat-fe-guiarem-transportistas/enviar-sunat/${id}`,
            data: '',
            type: 'POST',
            success: function (r) {
                console.log(r);
    ...
    obtenerCDR: function(id){
        ...
        $.ajax({
            url: `${base}sunat-fe-guiarem-transportistas/get-cdr/${id}`,
            data: '',
            type: 'POST',
            success: function (r) {
                console.log(r);

...
var ListadoNotasDebito = {
    ...
    ,Imprimir: function (formato , venta_id) {
        var endpoint = `${API_FE}/sunat-fe-notas-debito/api-imprimir-pdf/${venta_id}/${formato}`;
        $.ajax({
            url     :   endpoint,
            data    :   '',
            type    :   'GET',
...
var NotasCredito = {
    getData     : function(){
        var endpoint = `${API_FE}/sunat-fe-notas-debito/`;
        $.ajax({
            url     : endpoint,
            data    : { },
            type    : 'GET',
                ...
                <tr>
                    ...
                    switch (e.sunat_estado) {
                        case "":
                            ...
                            str += `                            
                                <a href="javascript:void(0)" data-id="${e.id}" onclick="ListadoNotasDebito.enviarSunat(event,this)">
